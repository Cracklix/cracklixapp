...
export default function Navbar() {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 w-[90%] max-w-lg z-50 md:hidden">
          ...
          return (
            <Link key={item.href} href={item.href} className="relative group">
              <div className={cn(
                ...
                <Icon size={22} className={cn("transition-transform group-hover:scale-110", isActive ? "fill-primary/20" : "")} />
